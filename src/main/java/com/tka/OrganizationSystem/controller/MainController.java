...
public class MainController {
	...
	@GetMapping("getparticularstatus/{status}")
	public List<Employee> getParticularStatus(@PathVariable String status) {

		List<Employee> list = service.getParticularStatus(status);

		return list;
	}

	@GetMapping("getparticulardepartment/{department}")
	public List<Employee> getParticularDepartment(@PathVariable String department) {

		List<Employee> list = service.getParticularDepartment(department);
	...
	@GetMapping("getsalarybysalary/{salary}")
